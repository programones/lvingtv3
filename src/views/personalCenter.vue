<template>
    <div class="personal-center">
        ...
        <div class="personal-header">
            <div class="closethis" @click="toTopage"><i class="el-icon-back"></i></div>
       ...
       <div class="personal-body">
           <ul>
               <li class="personal-imgifo">
                   <span><img :src="userIfo.headimgurl" alt="" width="50" height="50"></span>
                   <span>{{userIfo.nickname || '请先登陆'}}</span>
               </li>
               <li class="personal-adress" @click="toAdress"><span><i class="el-icon-location"></i> 我的收货地址</span> <span> <i class="iconfont icon-arrow-right" id="right"></i> </span>
               </li>
               <li class="personal-adress" @click="toEditPhone"><span><i class="el-icon-phone"></i> 手机号修改</span> <span> <i class="iconfont icon-arrow-right" id="right"></i> </span>
               </li>
               <li class="personal-adress" @click="toBankCard"><span><i class="el-icon-s-platform"></i> 绑定银行卡</span> <span> <i class="iconfont icon-arrow-right" id="right"></i> </span>
               </li>
               <li class="personal-adress" @click="clearCookie"><span><i class="el-icon-document-delete"></i> 退出登陆</span> <span> <i class="iconfont icon-arrow-right" id="right"></i> </span>
               </li>
               <li class="personal-adress" @click="loginOut"><span><i class="el-icon-s-release"></i> 注销账户</span> <span> <i class="iconfont icon-arrow-right" id="right"></i> </span>
               </li>
           </ul>
           </div>  
